...
torch.manual_seed(66) # 随机种子

# 如果有需要可以转换文件编码
# import codecs
# with codecs.open('凡人切片1.txt', 'r', encoding='gbk') as f:
#     content = f.read()
...
print("编码结果: ", encode("你好"))
print("解码结果: ", decode(encode("你好")))
...
def get_batch(split):
    ...
    # 确保能够从数据中提取出完整的长度为 block_size 的序列
...
# 保存模型权重
# save_file(model.state_dict(), "nanoGPT_model.safetensors")
